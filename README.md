...
- VPS (terminal): `bash -c "$(curl -fsSL https://raw.githubusercontent.com/drpropagaapp-creator/brasapay-gateway/main/install.sh)"`
...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/drpropagaapp-creator/brasapay-gateway/main/install.sh)"
```
...
```bash
GETFY_HTTP_PORT=8080 GETFY_DIR=/opt/getfy bash -c "$(curl -fsSL https://raw.githubusercontent.com/drpropagaapp-creator/brasapay-gateway/main/install.sh)"
```
...
VPS:
1. Conecte via SSH.
3. Execute: `bash -c "$(curl -fsSL https://raw.githubusercontent.com/drpropagaapp-creator/brasapay-gateway/main/update.sh)"`.
