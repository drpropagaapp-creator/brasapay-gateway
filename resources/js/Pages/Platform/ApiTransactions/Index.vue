...
const LIST_PATH = '/plataforma/transacoes-api';
const page = usePage();
                    ...
                    <tbody class="divide-y divide-zinc-100 dark:divide-zinc-700">
                        ...
                        >
                            ...
                            <td class="max-w-[220px] px-4 py-3" @click.stop>
                                <a
                                    v-if="o.partner_checkout_url"
                                    :href="o.partner_checkout_url"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    class="line-clamp-2 text-xs text-[var(--color-primary)] hover:underline"
                                >
                                    {{ o.partner_checkout_url }}
                                </a>
