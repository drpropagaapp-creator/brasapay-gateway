...
<template>
    <div :class="pageClass">
        <AuroraPageHeader title="Cliques e eventos" subtitle="Log detalhado com IP mascarado (LGPD) — todos os tenants." />
                    ...
                    <table class="min-w-full text-left text-xs">
                        ...
                        <tbody>
                            <tr v-for="r in rows" :key="r.id" class="border-t border-zinc-100 dark:border-zinc-800">
                                ...
                                <td class="max-w-[140px] truncate px-3 py-2">{{ r.seller_name || '—' }}</td>
                            ...
                            <tr v-if="!rows.length">
                                <td colspan="14" class="px-3 py-8 text-center text-zinc-500">Nenhum evento no período.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
