...
function onProductChange(e) {
    ...
    router.get(props.base_path, q, { preserveState: false });
}
</script>
...
<template>
    <div :class="pageClass">
        <AuroraPageHeader
            ...
            subtitle="Visão global da plataforma — filtre por infoprodutor."
        />
        ...
        <div class="mt-4 space-y-6">
            ...
            <div v-if="!seller_id" :class="[filterPanelClass, 'overflow-hidden']">
                <div class="border-b border-zinc-200 px-4 py-3 text-sm font-semibold dark:border-zinc-700">Top infoprodutores</div>
                <div class="overflow-x-auto">
                    <table class="min-w-full text-left text-sm">
                        <thead class="bg-zinc-50 text-xs uppercase text-zinc-500 dark:bg-zinc-800/80">
                            <tr>
                                <th class="px-3 py-2">Infoprodutor</th>
                        ...
                        <tbody>
                            <tr v-for="r in by_seller" :key="r.key" class="border-t border-zinc-100 dark:border-zinc-800">
