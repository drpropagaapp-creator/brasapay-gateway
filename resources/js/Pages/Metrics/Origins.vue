...
function reload(extra = {}) {
    ...
    router.get('/metricas/origem', q, { preserveState: false });
}
...
function exportParams() {
    const params = new URLSearchParams({
        ...
        type: 'origins',
        dimension: props.dimension || 'utm_source',
    });
...
<template>
    <div :class="pageClass">
        <AuroraPageHeader title="Origem das vendas" subtitle="Performance por fonte, campanha, produto e local." />
