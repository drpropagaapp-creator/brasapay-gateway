...
@section('content')
    <p style="margin:0 0 16px 0;font-size:18px;font-weight:600;color:#18181b;">MED aberta — gestão plataforma</p>
    <p style="margin:0 0 16px 0;">Uma disputa MED foi classificada como responsabilidade da plataforma (checkout interno ou MED Zero).</p>
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" style="margin:0 auto;">
        <tr>
            <td style="border-radius:8px;background-color:{{ $branding['theme_primary'] }};">
                <a href="{{ $disputeUrl }}" style="display:inline-block;padding:14px 28px;font-size:15px;font-weight:600;color:#ffffff;text-decoration:none;">Gerenciar disputa</a>
            </td>
        </tr>
    </table>
@endsection
