...
<head>
    ...
    <?php echo $__env->make('partials.panel-theme-init', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
    <title><?php echo e(config('getfy.app_name', config('app.name', 'Stacker'))); ?></title>
    <?php if (! ($skipPanelPwa)): ?>
    <?php
...
<?php /**PATH D:\stacker\stacker-gateway\resources\views/app.blade.php ENDPATH**/ ?>