...
{
    private const GITHUB_RELEASES_LATEST = 'https://api.github.com/repos/drpropagaapp-creator/brasapay-gateway/releases/latest';
    private const GITHUB_TAGS = 'https://api.github.com/repos/drpropagaapp-creator/brasapay-gateway/tags';
    private const DOCKER_MANUAL_UPDATE_COMMAND = 'bash -c "$(curl -fsSL https://raw.githubusercontent.com/drpropagaapp-creator/brasapay-gateway/main/update.sh)"';
    ...
    private function runArchiveUpdate(string $basePath, string $branch): array
    {
        ...
        $repo = 'drpropagaapp-creator/brasapay-gateway';
        $archiveUrl = $tagRaw
    ...
    public function run(Request $request): JsonResponse|RedirectResponse
    {
        ...
        $expectedRepo = config('getfy.update_repository_url', 'https://github.com/drpropagaapp-creator/brasapay-gateway.git');
        $timeout = 300;
