    ...
    public static function defaultCheckoutConfig(): array
    {
        return [
            ...
            'landing' => [
                ...
                'benefits' => '',
                'show_reviews' => true,
                // Ordem e visibilidade dos elementos da landing (reordenável no Builder).
                'sections' => [
                    ['id' => 'headline', 'visible' => true],
                    ['id' => 'subheadline', 'visible' => true],
                    ['id' => 'cta', 'visible' => true],
                    ['id' => 'video', 'visible' => true],
                    ['id' => 'hero_image', 'visible' => true],
                    ['id' => 'images', 'visible' => true],
                    ['id' => 'custom_html', 'visible' => true],
                    ['id' => 'benefits', 'visible' => true],
                    ['id' => 'reviews', 'visible' => true],
                    ['id' => 'cta_final', 'visible' => true],
                ],
            ],
            'youtube_url' => null,
            'vturb_embed' => '',
